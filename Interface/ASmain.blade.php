...
@section('content')
    ...
    <div class="panel-body">
        ...
        <br>
        If the data acquisition process was succesfully completed, you can retrieve the sampled data in a .csv by clicking the export data button.
        <br>
    </div>
    </div>
    </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-offset-3 col-sm-6">
                <button type="submit" class="btn btn-primary" onclick="buttonExecuteClicked('whoami')">
                    <i class="fa aria-hidden="true""></i>  Execute
                </button>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-offset-3 col-sm-6">
                <button type="submit" class="btn btn-danger" onclick="buttonExecuteClicked('echo Running')">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-offset-3 col-sm-6">
                <button type="submit" class="btn btn-success" onclick="buttonExecuteClicked('echo Exporting data')">
